...
describe("plain-message", () => {
  it.each(["plain-message", "partial-message", "mixed", "no-transform", "partial-message-no-schema-import", "partial-message-type-only-import", "partial-builtin", "partial-builtin-non-protobuf"])(
